...
1. In the list of users, click Refresh button and select the newly created user account to display its blade.
...
1. On the **Configure Rules** tab of the **Dynamic membership rules** blade, to create a new rule with the following settings:
...
1. Navigate back to the **Users - All users** blade, and then click **+ New user**, **Invite external user**.
